...
class AngularPipeline implements Serializable {
    ...
    void test(script) {
        def test = script.readFile '../../../../resources/org/aomerge/docker/angular/Dockerfile.test'
    ...
    void build(script) {
        def build = script.readFile '../../../../resources/org/aomerge/docker/angular/Dockerfile'
